package com.example.justnotes_jetpackcompose.create_and_update_note.presentation
...
import com.example.justnotes_jetpackcompose.core.ui_kit.BasicFilledButtonJustNotes
import com.example.justnotes_jetpackcompose.core.ui_kit.JustNotesTextField
...
private fun Content(
    ...
    Column(
        ...
        JustNotesTextField(modifier = Modifier
            .width(300.dp)
            .padding(top = 40.dp),
            text = title,
        ...
        BasicFilledButtonJustNotes(
            ...
            onClick = {
                if (title.isEmpty()) {
                    Toast.makeText(
                        context, context.getText(R.string.please_fill_out_the_title_field),
